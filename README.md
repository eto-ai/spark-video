...
sudo wget -O /databricks/jars/spark-video-assembly-0.0.3.jar https://github.com/eto-ai/spark-video/releases/download/v0.0.3/spark-video-assembly_2.12-0.0.3.jar
```
